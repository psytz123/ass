...
from ai_framework.models import ModelProvider, ModelRequest, ModelResponse
...
async def test_reasoning_and_logic(self, knowledge_framework):
    ...
    logic_tests = [
        ...
        {
            "prompt": "A bat and a ball cost .10 in total. The bat costs .00 more than the ball. How much does the ball cost?",
...
# Test with specific provider only

pytest tests/test_ai_knowledge_integration.py –provider openai

# Run cross-model comparison

pytest tests/test_ai_knowledge_integration.py::TestKnowledgeComparison::test_cross_model_knowledge_quality -v -s
“””